...
*/
	...
	$an = new GCMPushMessage('YOUR-GCM-ID-HERE');
    $an->setDevices(array(	
    	'YOUR-DEVICE-GCM-IDS-HERE',
	));
	// return chillis in range of 1-10. 
    $response = $an->send('{"chillis": ' . rand(1, 10) . '}');
	...
	*/
	function send($message, $data = false){
		...
		$fields = array(
			...
			'data'              => array( "message" => $message, "title" => "hello world!" ),
		);
